...
browser.find_element_by_xpath("//td/a[text()='"+ExpUserName+"']//parent::td/../td[text()='Admin']").is_displayed()
browser.find_element_by_xpath("//td/a[text()='"+ExpUserName+"']//parent::td/../td[text()='Admin']/../td/input").click()
time.sleep(5)
browser.find_element_by_id("btnDelete").click()
browser.find_element_by_id("dialogDeleteBtn").click()
time.sleep(5)

#Verify user got deleted ot not
...
print(search_text not in get_source)

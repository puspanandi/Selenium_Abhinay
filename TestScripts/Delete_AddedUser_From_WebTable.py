...
browser.find_element_by_id("searchSystemUser_userName").send_keys(textvalue)
browser.find_element_by_id("searchBtn").click()
time.sleep(2)
Act_Res = browser.find_element_by_xpath("//td[normalize-space()='No Records Found']").text
assert Act_Res == "No Records Found"
browser.close()